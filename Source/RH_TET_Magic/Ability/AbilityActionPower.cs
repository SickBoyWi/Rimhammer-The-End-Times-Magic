...
{
    public class AbilityActionPower : IExposable
    {
        ...
        public AbilityActionPower(List<AbilityDef> newAbilityDefs)
        {
            this.level = 0;
        ...
        {
            Scribe_Values.Look<int>(ref this.level, "abilityActionLevel", 0, false);
            Scribe_Values.Look<int>(ref this.ticksUntilNextCast, "ticksUntilNextAbilityActionCast", -1, false);
            Scribe_Collections.Look<AbilityDef>(ref this.abilityDefs, "abilityActionAbilityDefs", LookMode.Def, (object[])null);
        }
    }
}
