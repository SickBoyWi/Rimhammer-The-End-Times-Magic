...
namespace TheEndTimes_Magic
{
    ...
    public class CompMagicShield : ThingComp
    {
        ...
        public CompProperties_MagicShield Props
        {
            get
            {
                return (CompProperties_MagicShield)this.props;
            }
        }
        ...
        protected Pawn PawnOwner
        {
            get
            {
                ...
                return this.parent is Pawn parentPawn ? parentPawn : (Pawn)null;
            }
        }
        ...
        {
            CompMagicShield compShield = this;
            ...
            if (DebugSettings.ShowDevGizmos)
            {
                ...
                if (compShield.ticksToReset > 0)
                {
                    ...
                    commandAction2.action = new Action((() =>
                    {
                        compShield.ticksToReset = 0;
                    }));
        ...
        private IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if ((compShield.PawnOwner.Faction == Faction.OfPlayer || compShield.parent is Pawn parent && parent.RaceProps.IsMechanoid) && Find.Selector.SingleSelectedThing == compShield.PawnOwner)
                yield return (Gizmo)new Gizmo_MagicShieldStatus()
                {
                    shield = compShield
                };
        }
        ...
        private void Draw()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, CompMagicShield.BubbleMat, 0);
        }
