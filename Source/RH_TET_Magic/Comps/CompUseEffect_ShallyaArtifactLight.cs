...
{
    public class CompUseEffect_ShallyaArtifactLight : CompUseEffect
    {
        public override void DoEffect(Pawn user)
        {
            ...
            if (user.IsFaithUserShallya())
            {
                ...
                if (compUser != null)
                {
                    ...
                    {
                        if (pawnAbility.Def.defName.Equals(RH_TET_MagicDefOf.RH_TET_Shallya_Light.defName))
                        { 
                            alreadyHad = true;
                            break;
                        }
                    ...
                    {
                        FaithPower newFaithPower = compUser.FaithData.PowersShallya.Find((Predicate<FaithPower>)(x => x.abilityDef.defName.Equals(RH_TET_MagicDefOf.RH_TET_Shallya_Light.defName)));
                        ...
                        Messages.Message("RH_TET_SigmarArtifactUsed".Translate(user.Name, ("RH_TET_ShallyaLightAbility".Translate() + ".")), (LookTargets)((Thing)user), MessageTypeDefOf.PositiveEvent, true);
                    }
                }
            }
            else
