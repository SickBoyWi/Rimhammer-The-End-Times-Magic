...
{
    public class CompUseEffect_SigmarArtifactShield : CompUseEffect
    {
        public override void DoEffect(Pawn user)
        {
            ...
            if (user.IsFaithUserSigmar())
            {
                ...
                if (compUser != null)
                {
                    ...
                    {
                        if (pawnAbility.Def.defName.Equals(RH_TET_MagicDefOf.RH_TET_Sigmar_Shield.defName))
                        { 
                            alreadyHad = true;
                            break;
                        }
                    ...
                    {
                        FaithPower newFaithPower = compUser.FaithData.PowersSigmar.Find((Predicate<FaithPower>)(x => x.abilityDef.defName.Equals(RH_TET_MagicDefOf.RH_TET_Sigmar_Shield.defName)));
                        ...
                        Messages.Message("RH_TET_SigmarArtifactUsed".Translate(user.Name, ("RH_TET_SigmarShieldAbility".Translate() + ".")), (LookTargets)((Thing)user), MessageTypeDefOf.PositiveEvent, true);
                    }
                }
            }
            else
