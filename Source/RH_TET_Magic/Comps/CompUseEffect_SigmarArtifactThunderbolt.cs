...
{
    public class CompUseEffect_SigmarArtifactThunderbolt : CompUseEffect
    {
        public override void DoEffect(Pawn user)
        {
            ...
            if (user.IsFaithUserSigmar())
            {
                ...
                if (compUser != null)
                {
                    ...
                    {
                        if (pawnAbility.Def.defName.Equals(RH_TET_MagicDefOf.RH_TET_Sigmar_Thunderbolt.defName))
                        { 
                            alreadyHad = true;
                            break;
                        }
                    ...
                    {
                        FaithPower newFaithPower = compUser.FaithData.PowersSigmar.Find((Predicate<FaithPower>)(x => x.abilityDef.defName.Equals(RH_TET_MagicDefOf.RH_TET_Sigmar_Thunderbolt.defName)));
                        ...
                        Messages.Message("RH_TET_SigmarArtifactUsed".Translate(user.Name, ("RH_TET_SigmarThunderboltAbility".Translate() + ".")), (LookTargets)((Thing)user), MessageTypeDefOf.PositiveEvent, true);
                    }
                }
            }
            else
        ...
        public override bool CanBeUsedBy(Pawn p, out string failReason)
        {
            ...
            {
                failReason = "RH_TET_SigmarArtifactCannotUse".Translate("Sigmar");
                return false;
            }
        }
    }
