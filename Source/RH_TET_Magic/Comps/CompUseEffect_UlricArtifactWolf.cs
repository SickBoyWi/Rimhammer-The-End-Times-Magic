...
{
    public class CompUseEffect_UlricArtifactWolf : CompUseEffect
    {
        public override void DoEffect(Pawn user)
        {
            ...
            if (user.IsFaithUserUlric())
            {
                ...
                if (compUser != null)
                {
                    ...
                    {
                        if (pawnAbility.Def.defName.Equals(RH_TET_MagicDefOf.RH_TET_Ulric_Wolf.defName))
                        { 
                            alreadyHad = true;
                            break;
                        }
                    ...
                    {
                        FaithPower newFaithPower = compUser.FaithData.PowersUlric.Find((Predicate<FaithPower>)(x => x.abilityDef.defName.Equals(RH_TET_MagicDefOf.RH_TET_Ulric_Wolf.defName)));
                        ...
                        Messages.Message("RH_TET_SigmarArtifactUsed".Translate(user.Name, ("RH_TET_UricWolfAbility".Translate() + ".")), (LookTargets)((Thing)user), MessageTypeDefOf.PositiveEvent, true);
                    }
                }
            }
            else
