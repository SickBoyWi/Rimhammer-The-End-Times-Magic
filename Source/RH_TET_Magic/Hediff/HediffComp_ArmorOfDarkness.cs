...
namespace TheEndTimes_Magic
{
    ...
    public class HediffComp_ArmorOfDarkness : HediffComp
    {
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Magic/RH_TET_StealthArmorDarkness", ShaderDatabase.Transparent);
        ...
        {
            HediffComp_ArmorOfDarkness hediffCompShield = this;
            if (Find.Selector.SingleSelectedThing == hediffCompShield.Pawn)
                yield return (Gizmo)new Gizmo_HediffArmorOfDarknessStatus()
                {
        ...
        public void DrawWornExtras()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, HediffComp_ArmorOfDarkness.BubbleMat, 0);
        }
    }
}
