...
namespace TheEndTimes_Magic
{
    ...
    public class HediffComp_FireCloak : HediffComp
    {
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Magic/RH_TET_FireCascadingCloak", ShaderDatabase.Transparent);
        ...
        {
            HediffComp_FireCloak hediffCompShield = this;
            if (Find.Selector.SingleSelectedThing == hediffCompShield.Pawn)
                yield return (Gizmo)new Gizmo_HediffFireCloakStatus()
                {
        ...
        public void DrawWornExtras()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, HediffComp_FireCloak.BubbleMat, 0);
        }
    }
}
