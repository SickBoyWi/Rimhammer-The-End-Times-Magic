...
namespace TheEndTimes_Magic
{
    ...
    public class HediffComp_GlitteringRobe : HediffComp
    {
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Magic/RH_TET_MetalGlitteringRobe", ShaderDatabase.Transparent);
        ...
        {
            HediffComp_GlitteringRobe hediffCompShield = this;
            if (Find.Selector.SingleSelectedThing == hediffCompShield.Pawn)
                yield return (Gizmo)new Gizmo_HediffGlitteringRobeStatus()
                {
        ...
        public void DrawWornExtras()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, HediffComp_GlitteringRobe.BubbleMat, 0);
        }
    }
}
