...
namespace TheEndTimes_Magic
{
    ...
    {
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Magic/RH_TET_TzeentchOrangeFire", ShaderDatabase.Transparent);
        ...
        {
            HediffComp_MagicShield hediffCompShield = this;
            if (Find.Selector.SingleSelectedThing == hediffCompShield.Pawn)
                yield return (Gizmo)new Gizmo_HediffMagicShieldStatus()
                {
        ...
        public void DrawWornExtras()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, HediffComp_MagicShield.BubbleMat, 0);
        }
    }
}
