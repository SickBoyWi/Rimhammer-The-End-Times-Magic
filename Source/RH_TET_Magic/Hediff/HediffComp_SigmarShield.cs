...
namespace TheEndTimes_Magic
{
    ...
    public class HediffComp_SigmarShield : HediffComp
    {
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Faith/RH_TET_SigmarShield", ShaderDatabase.Transparent);
        ...
        private float EnergyLossPerDamage = 0.015f;
        ...
        {
            HediffComp_SigmarShield hediffCompShield = this;
            if (Find.Selector.SingleSelectedThing == hediffCompShield.Pawn)
                yield return (Gizmo)new Gizmo_HediffSigmarShieldStatus()
                {
        ...
        private void AbsorbedDamage(DamageInfo dinfo)
        {
            ...
            for (int index = 0; index < num; ++index) { 
                ...
                FleckMaker.ThrowMicroSparks(loc, this.Pawn.Map);
            }
        ...
        public void DrawWornExtras()
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, matrix, HediffComp_SigmarShield.BubbleMat, 0);
        }
    }
}
