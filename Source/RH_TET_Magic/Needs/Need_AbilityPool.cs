...
{
    public class Need_AbilityPool : Need
    {
        ...
        public AbilityPoolCategory CurCategory
        {
            get
            {
                if ((double)this.CurLevel < 0.00999999977648258)
                    return AbilityPoolCategory.Drained;
                if ((double)this.CurLevel < 0.300000011920929)
                    return AbilityPoolCategory.Feeble;
                if ((double)this.CurLevel < 0.5)
                    return AbilityPoolCategory.Steady;
                return (double)this.CurLevel < 0.699999988079071 ? AbilityPoolCategory.Strong : AbilityPoolCategory.Surging;
            }
        }
        ...
        public Need_AbilityPool(Pawn pawn)
          : base(pawn)
        {
        ...
        public void UseAbilityActionPower(float amount)
        {
