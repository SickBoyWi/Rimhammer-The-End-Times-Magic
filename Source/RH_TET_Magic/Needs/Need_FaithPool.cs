...
{
    public class Need_FaithPool : Need
    {
        ...
        public FaithPoolCategory CurCategory
        {
            get
            {
                if ((double)this.CurLevel < 0.00999999977648258)
                    return FaithPoolCategory.Drained;
                if ((double)this.CurLevel < 0.300000011920929)
                    return FaithPoolCategory.Feeble;
                if ((double)this.CurLevel < 0.5)
                    return FaithPoolCategory.Steady;
                return (double)this.CurLevel < 0.699999988079071 ? FaithPoolCategory.Strong : FaithPoolCategory.Surging;
            }
        }
        ...
        public Need_FaithPool(Pawn pawn)
          : base(pawn)
        {
        ...
        public void UseFaithPower(float amount)
        {
