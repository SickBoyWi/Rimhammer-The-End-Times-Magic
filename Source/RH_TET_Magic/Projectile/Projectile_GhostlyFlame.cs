...
{
    public class Projectile_GhostlyFlame : Projectile_AbilityBase
    {
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            FleckMaker.Static(casterLocation, map, RH_TET_MagicDefOf.RH_TET_FleckGreenEffect, 1);

            Thing light = ThingMaker.MakeThing(RH_TET_MagicDefOf.RH_TET_GhostlyLight);
        ...
        public Projectile_GhostlyFlame()
            : base()
        {
        }
    }
