...
{
    public class Projectile_LightCantrip : Projectile_AbilityBase
    {
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            Thing light = ThingMaker.MakeThing(RH_TET_MagicDefOf.RH_TET_LightCantrip);
        ...
        public Projectile_LightCantrip()
            : base()
        {
        }
    }
