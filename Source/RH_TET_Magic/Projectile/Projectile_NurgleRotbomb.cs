...
{
    public class Projectile_NurgleRotbomb : Projectile_AbilityBase
    {
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            GenExplosion.DoExplosion(this.Position, map, ((Thing)this).def.projectile.explosionRadius, RimWorld.DamageDefOf.Bomb, this.launcher, Mathf.RoundToInt((float)Rand.Range(((Thing)this).def.projectile.GetDamageAmount(null, (StringBuilder)null) / 5, ((Thing)this).def.projectile.GetDamageAmount(null, (StringBuilder)null)) * 1), 0.0f, SoundDef.Named("InfernoCannon_Fire"), def, this.equipmentDef, (Thing)null, (ThingDef)null, 0.0f, 1, new GasType?(),new float?(), new int(), false, (ThingDef)null, 0.0f, 1, 0.1f, true);
          ...
          int preExplosionSpawnThingCount = 1)
        {
            ...
            else
            {
                ...
                explosion.damAmount = projectile != null ? projectile.projectile.GetDamageAmount(null) : 5;
        ...
        public Projectile_NurgleRotbomb()
            : base()
        {
        }
    }
