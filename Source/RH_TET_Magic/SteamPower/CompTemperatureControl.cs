...
namespace TheEndTimes_Magic
{
     ...
     * trimmed down/altered to suit this mod's needs.
     */
    public class CompTemperatureControl : ThingComp
    {
        ...
        {
            Scribe_Values.Look<float>(ref this.targetTemperature, "targetTemperature", DefaultTargetTemperature, false);
        ...
        {
            CompTemperatureControl dbhCompTempControl = this;

            foreach (Gizmo gizmo in base.CompGetGizmosExtra())
                yield return gizmo;

            float offset = dbhCompTempControl.RoundedToCurrentTempModeOffset(-10f);
            ...
            float offset4 = dbhCompTempControl.RoundedToCurrentTempModeOffset(-1f);
            ...
            commandAction3.action = new Action(dbhCompTempControl.resettemp);
            ...
            float offset3 = dbhCompTempControl.RoundedToCurrentTempModeOffset(1f);
            ...
            float offset2 = dbhCompTempControl.RoundedToCurrentTempModeOffset(10f);
