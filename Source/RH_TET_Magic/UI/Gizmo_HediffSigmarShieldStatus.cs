...
namespace TheEndTimes_Magic
{
    ...
    internal class Gizmo_HediffSigmarShieldStatus : Gizmo
    {
        private static readonly Texture2D FullShieldBarTex = SolidColorMaterials.NewSolidColorTexture(new Color(0.2f, 0.2f, 0.24f));
        private static readonly Texture2D EmptyShieldBarTex = SolidColorMaterials.NewSolidColorTexture(Color.clear);
        public HediffComp_SigmarShield shield;
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
        {
            ...
            Find.WindowStack.ImmediateWindow(984688, overRect, WindowLayer.GameUI,
                    (Action)(() =>
                    {
                        ...
                        Widgets.FillableBar(rect3, fillPercent, Gizmo_HediffSigmarShieldStatus.FullShieldBarTex, Gizmo_HediffSigmarShieldStatus.EmptyShieldBarTex, false);
