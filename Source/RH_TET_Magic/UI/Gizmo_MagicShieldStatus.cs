...
namespace TheEndTimes_Magic
{
    ...
    public class Gizmo_MagicShieldStatus : Gizmo
    {
        private static readonly Texture2D FullShieldBarTex = SolidColorMaterials.NewSolidColorTexture(new Color(0.2f, 0.2f, 0.24f));
        private static readonly Texture2D EmptyShieldBarTex = SolidColorMaterials.NewSolidColorTexture(Color.clear);
        public CompMagicShield shield;

        public Gizmo_MagicShieldStatus()
        {
            this.Order = -100f;
        }
          ...
          GizmoRenderParms parms)
        {
            ...
            Widgets.FillableBar(rect4, fillPercent, Gizmo_MagicShieldStatus.FullShieldBarTex, Gizmo_MagicShieldStatus.EmptyShieldBarTex, false);
