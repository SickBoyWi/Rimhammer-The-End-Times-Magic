...
{
    public class Verb_BestialSurge : Verb_UseAbility
    {
        protected override bool TryCastShot()
        {
            ...
            {
                if (mp.abilityDef.defName.Contains("BestialSurge"))
                {
                    magicPower = mp;
                }
            }
            ...
            if (magicPower == null)
            {
                Log.Error("Someone tried to cast Bestial Surge, but didn't have the spell.");
                return false;
            }
            ...
            for (int i = 0; i < this.TargetsAoE.Count; ++i)
            {
                ...
                if (target != null)
                {
                    ...
                    target.health.AddHediff(RH_TET_MagicDefOf.RH_TET_WildBestialSurge);
                    maxTargets--;
                    flag1 = true;
                    continue;
                }
