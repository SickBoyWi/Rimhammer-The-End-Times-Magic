...
{
    public class Verb_Manacles : Verb_UseAbility
    {
        protected override bool TryCastShot()
        {
            ...
            {
                if (mp.abilityDef.defName.Contains("Manacles"))
                {
                    magicPower = mp;
                }
            }
            ...
            if (magicPower == null)
            {
                Log.Error("Someone tried to cast Manacles, but didn't have the spell.");
                return false;
            }
            ...
            for (int i = 0; i < this.TargetsAoE.Count; ++i)
            {
                ...
                if (target != null)
                {
                    ...
                    target.health.AddHediff(RH_TET_MagicDefOf.RH_TET_DeathManacles);
                    maxTargets--;
                    flag1 = true;
                    continue;
                }
