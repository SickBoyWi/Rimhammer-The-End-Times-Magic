...
{
    public class Verb_Toothcracker : Verb_UseAbility
    {
        protected override bool TryCastShot()
        {
            ...
            {
                if (mp.abilityDef.defName.Contains("Toothcracker"))
                {
                    magicPower = mp;
                }
            }
            ...
            if (magicPower == null)
            {
                Log.Error("Someone tried to cast Toothcracker, but didn't have the spell.");
                return false;
            }
            ...
            FleckMaker.Static(casterLocation, map, RH_TET_MagicDefOf.RH_TET_FleckBrownEffect, 2f);
            ...
            for (int i = 0; i < this.TargetsAoE.Count; ++i)
            {
                ...
                if (target != null)
                {
                    ...
                    target.health.AddHediff(RH_TET_MagicDefOf.RH_TET_Magic_Toothcracker);
                    maxTargets--;
                    flag1 = true;
                    continue;
                }
